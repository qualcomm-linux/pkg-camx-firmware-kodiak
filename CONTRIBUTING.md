# Contributing to pkg-camx-firmware-kodiak
...
1. [Fork](https://github.com/qualcomm-linux/pkg-camx-firmware-kodiak/fork) and clone the repository.

    ```bash
    git clone https://github.com/qualcomm-linux/pkg-camx-firmware-kodiak.git
    ```
...
1. [Submit a pull request](https://github.com/qualcomm-linux/pkg-camx-firmware-kodiak.git/pulls) from your branch to `qcom/debian/latest`.
